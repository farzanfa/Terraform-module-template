# =============================================================================
# S3-CloudFront Module - Main Configuration
# =============================================================================
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  aliases             = var.create_acm_certificate ? ["${var.frontend_subdomain}.${var.domain_name}"] : []
  ...
  viewer_certificate {
    acm_certificate_arn            = var.create_acm_certificate ? aws_acm_certificate.frontend[0].arn : null
